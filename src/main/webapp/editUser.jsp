...
<html style="height: auto;"><head>
	...
	<body style="height: auto;">
	        ...
	        <div class="form-horizontal">
				<div class="card-body">
			           ...
			           <div class="form-group">
			                 ...
			                 <div class="col-sm-10">
			                 	<input value="" type="text" name="editTrueName" id="editTrueName" class="form-control" style="width:600px" maxlength="20">
			                 </div>
			             </div>
			             <div class="form-group">
			                 <label for="JI_JOB_NAME" class="col-sm-2 control-label">电子邮箱：</label>
			                 <div class="col-sm-10">
			                 	<input value="" type="text" name="editEmail" id="editEmail" class="form-control" style="width:600px" maxlength="20">
			                 </div>
			              </div>
			              <div class="form-group">
			                 <label for="JI_JOB_NAME" class="col-sm-2 control-label">手机号码：</label>
			                 <div class="col-sm-10">
			                 	<input value="" type="text" name="editPhone" id="editPhone" class="form-control" style="width:600px" maxlength="20">
			                 </div>
			              </div>
			              <div class="form-group">
			                 <label for="JI_JOB_NAME" class="col-sm-2 control-label">送货地址：</label>
			                 <div class="col-sm-10">
			                 	<input value="" type="text" name="editAddress" id="editAddress" class="form-control" style="width:600px" min="50">
			                 </div>
			       		  </div>
			              <!-- /.card-body -->
	             <!-- /.card-body -->
		...
		<script src="<%=path %>/chinasofti/editUser/js/editUser.js"></script>
