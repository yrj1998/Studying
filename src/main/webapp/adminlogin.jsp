...
<html class="no-touch"><head>
		...
		<script type="text/javascript" src="<%=path %>/static/loginUI/js/TweenLite.min.js"></script><link id="layuicss-layer" rel="stylesheet" href="static/comp/layui/css/modules/layer/default/layer.css?v=3.1.1" media="all">
		...
		<script type="text/javascript" src="<%=path %>/chinasofti/adminlogin/js/adminlogin.js"></script>
	...
	<body style="width: 100%;height: 100%;margin: 0;padding: 0; ">
		<div class="bg-canvas">
			<canvas id="demo-canvas" width="1366" height="407" style="width: 100%; height: 407px; overflow: hidden;"></canvas>
		</div>
					...
					<div id="message" style="position:absolute;color:red;margin-top:-20px;margin-left:100px;"> </div>
						...
						<div class="content">
					        ...
					        <div class="formitem">
					        	...
					        	<span class="input">
					        		<input id="loginName" name="loginName" value="" class="form-control l35" fv_type="NOTCN" type="text" maxlength="20" placeholder="请输入您的用户名" data-toggle="tooltip" data-placement="right">
					        	</span>
					        </div>
					        <div class="formitem">
					        ...
					        <div>
					        	<button type="button" onclick="subLogin()" id="login-submit-btn" class="layui-btn  btn-login" style="width:150px">&nbsp;&nbsp;登　录&nbsp;&nbsp;</button>
					       	    <button type="button" title="刷脸登录" data-search-open="" data-title="刷脸登录" modal-toggle="modal" data-href="adminFace.html" data-width="780" data-height="500" class="layui-btn  btn-login" style="width:150px">&nbsp;&nbsp;刷    脸&nbsp;&nbsp;</button>
						    </div> 
